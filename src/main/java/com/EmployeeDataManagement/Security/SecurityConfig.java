...
//	     	.antMatchers(HttpMethod.POST,"setPassword").permitAll()
	     	...
	     	.antMatchers("/employeeList").hasAnyRole("ADMIN","ANALYST")
	     	.antMatchers("/update").hasAnyRole("ANALYST","USER")
	     	.antMatchers("/profile","/updateEmployeeDetails").hasAnyRole("ADMIN","ANALYST","USER")
